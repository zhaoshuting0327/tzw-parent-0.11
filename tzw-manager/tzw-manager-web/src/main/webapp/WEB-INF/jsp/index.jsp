...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:#F3F3F3"> 
		<span class="northTitle">兔子屋后台管理系统</span>
	    <span class="loginInfo">登录：${username}</span>
	</div>
    	...
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		...
         		<ul>
	         		...
	         		<li data-options="attributes:{'url':'/item/itemList'}">查询商品</li>
	         	</ul>
         	</li>
         	<li>
         		<span>用户管理</span>
         		<ul>
	         		...
	         		<li data-options="attributes:{'url':'/item/itemList'}">查询用户</li>
		</ul>
         	</li>
         	<li>
         		<span>订单管理</span>
			...
			<span>活动管理</span>
			<ul>
				<li data-options="attributes:{'url':'order-list'}">活动查询</li>
			</ul>
			</li>
         </ul>
    </div>
